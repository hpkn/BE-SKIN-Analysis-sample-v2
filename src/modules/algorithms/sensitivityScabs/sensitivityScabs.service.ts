...
export class SensitivityScabsService {
    ...
    analysis(data: AlgoAnalysisDTO, taskResponse: any) {
        ...
        const analyzedImageArgs = this.S3Image.getImageArgs('analyzedImage', data.task.algoName, 'sensitivityscabs');
        const maskImageArgs = this.S3Image.getImageArgs('maskImage', data.task.algoName, 'sensitivityscabs');

        const originalImageArgs = this.S3Image.getImageArgs('originalImage', data.task.algoName, 'sensitivityscabs');
