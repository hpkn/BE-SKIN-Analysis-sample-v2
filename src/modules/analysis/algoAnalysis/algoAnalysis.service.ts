    ...
    async userAnalysisHistory(customer_id: number, per: number, page: number): Promise<any[]> {
        ...
        try {
            ...
            nonEmptyResults.map((val) => {
                ...
                val.keratin_score = Number(val.keratin_score);
                val.pores_score = Number(val.pores_score);
                val.sensitivity_redness_score = Number(val.sensitivity_redness_score);
                val.spots_score = Number(val.spots_score);
                val.wrinkles_score = Number(val.wrinkles_score);
                val.porphiryn_score = Number(val.porphiryn_score);
                val.moisture_score = Number(val.moisture_score);
                val.sebum_score = Number(val.sebum_score);
                val.shine_score = Number(val.shine_score);
                val.skintone_score = Number(val.skintone_score);
                val.sensitivity_scabs_score = Number(val.sensitivity_scabs_score);
                val.sensitivity_scaling_score = Number(val.sensitivity_scaling_score);
                val.moisture_u_score = Number(val.moisture_u_score);
                val.moisture_t_score = Number(val.moisture_t_score);
                val.sebum_u_score = Number(val.sebum_u_score);
                val.sebum_t_score = Number(val.sebum_t_score);
            });
